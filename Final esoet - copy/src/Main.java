...
public class Main {
	...
	public static void main(String[] args) {
		...
		String   username = "謝祥祥";
		boolean  VIP  = false;
		Position 男六 = new Position("106台北市大安區長興街31號",25.016731, 121.545355);
		...
		//舉個例子  假設我選餐廳 春來麵線
		currentCart = new ShopCart(username,VIP,男六,Restaurant.GetARestaurantFromArray(Allrt, "春來麵線"));
		//不要這間餐廳就直接選其他餐廳
		
		//比如選 樸食
		currentCart = null;
		currentCart = new ShopCart(username,VIP,男六,rtt);
